/*
 * ! FileSaver.js A saveAs() FileSaver implementation. 2014-01-24
 * 
 * By Eli Grey, http://eligrey.com License: X11/MIT See LICENSE.md
 */
    ...
    var
        ...
        , FileSaver = function(blob, name) {
            ...
            var
                ...
                , fs_error = function() {
                    ...
                    if (target_view) {
                        ...
                        if(navigator.userAgent.match(/7\.[\d\s\.]+Safari/)  // is
																			// Safari
																			// 7.x
                                && typeof window.FileReader !== "undefined"         // can
																					// convert
																					// to
																					// base64
                                && blob.size <= 1024*1024*150                                       // file
																									// size
																									// max
																									// 150MB
                                ) { 
            ...
            if (can_use_save_link) {
                ...
                // that turns all objects that are not pure javascript into
				// 'deadObject'
                // this means `doc` and `save_link` are unusable and need to be
				// recreated
