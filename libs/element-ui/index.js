	...
	return function(e) {
		...
		t.validators = {
			required: function(e, t, i) {
				!t || "" === t || t.length < 1 ? i(new Error("字段不能为空")) : i()
			},
			number: function(e, t, i) {
				var n = /^[\d\.\,]*$/;
				t && n.test(t) ? i() : t && !n.test(t) ? i(new Error("请输入数字")) : i()
			},
			age: function(e, t, i) {
				var n = /^\d+$/;
				if (t && n.test(t)) {
					var a = parseInt(t, 10);
					a < 200 ? i() : i(new Error("年龄不合法"))
				} else t && !n.test(t) ? i(new Error("数字类型错误")) : i()
			},
			postcode: function(e, t, i) {
				var n = /^[1-9]\d{5}$/;
				t && n.test(t) ? i() : t && !n.test(t) ? i(new Error("邮编格式不正确")) : i()
			},
			ip: function(e, t, i) {
				var n =
					/^(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])$/;
				t && n.test(t) ? i() : t && !n.test(t) ? i(new Error("ip地址格式不正确")) : i()
			},
			telephone: function(e, t, i) {
				var n = /(^\d{3}\-\d{7,8}$)|(^\d{4}\-\d{7,8}$)|(^\d{3}\d{7,8}$)|(^\d{4}\d{7,8}$)|(^\d{7,8}$)/;
				t && n.test(t) ? i() : t && !n.test(t) ? i(new Error("固定电话或小灵通电话格式不正确")) : i()
			},
			phone: function(e, t, i) {
				var n = /(^\d{3}\-1[3458][0-9]\d{8}$)|(^\d{2}\-1[3458][0-9]\d{8}$)/;
				t && n.test(t) ? i() : t && !n.test(t) ? i(new Error("固定电话格式不正确")) : i()
			},
			numberAndLetter: function(e, t, i) {
				var n = /(^[A-Za-z0-9]+$)|([A-Za-z]+$)|([0-9]+$)/;
				t && n.test(t) ? i() : t && !n.test(t) ? i(new Error("请输入数字和字母")) : i()
			},
			mobile: function(e, t, i) {
				var n = /^1[3-9][0-9]\d{8}$/;
				t && n.test(t) ? i() : t && !n.test(t) ? i(new Error("手机号码不正确")) : i()
			},
			IDCard: function(e, t, i) {
				...
				if (t) {
					var a, o, r, s, l = {
						...
						u = [];
					switch (u = t.split(""), null == l[parseInt(t.substr(0, 2), 10)] && i(new Error("身份证号码地区非法")), t.length) {
						case 15:
							n = (parseInt(t.substr(6, 2), 10) + 1900) % 4 === 0 || (parseInt(t.substr(6, 2), 10) + 1900) % 100 === 0 &&
								...
								n.test(t) ? i() : i(new Error("身份证号码出生日日期有误"));
							break;
						case 18:
							n = parseInt(t.substr(6, 4), 10) % 4 === 0 || parseInt(t.substr(6, 4), 10) % 100 === 0 && parseInt(t.substr(
								...
								n.test(t) ? (r = 7 * (parseInt(u[0], 10) + parseInt(u[10], 10)) + 9 * (parseInt(u[1], 10) + parseInt(u[11],
									...
									parseInt(u[9], 10), a = r % 11, s = "F", o = "10X98765432", s = o.substr(a, 1), s === u[17] ? i() : i(
										new Error("身份证号码末位校验位校验出错,请注意x的大小写"))) : i(new Error("身份证号码出生日期有误"));
							break;
						default:
							i(new Error("身份证号码位数不对,应该为15位或是18位"))
					}
				} else i()
			},
			isChnChar: function(e, t, i) {
				var n = /[\u4E00-\u9FA5]/;
				t && n.test(t) ? i() : t && !n.test(t) ? i(new Error("只能输入中文")) : i()
			},
			trim: function(e, t, i) {
				t !== t.trim() ? i(new Error("输入项首尾有空格")) : i()
			},
			email: function(e, t, i) {
				var n = /[A-Za-z0-9_-]+[@](\S*)(net|com|cn|org|cc|tv|[0-9]{1,3})(\S*)/g;
				t && n.test(t) ? i() : t && !n.test(t) ? i(new Error("电子邮箱格式不正确")) : i()
			},
			digit: function(e, t, i) {
				var n = /^-?\d+(\.\d+)?$/g;
				t && n.test(t) ? i() : t && !n.test(t) ? i(new Error("请输入小数")) : i()
			},
			pInt: function(e, t, i) {
				var n = /^\+?[1-9][0-9]*$/;
				t && n.test(t) ? i() : t && !n.test(t) ? i(new Error("请输入非零正整数")) : i()
			},
			...
			speChar: function(e, t, i) {
				var n = new RegExp("[`~!@#$^&*()=|{}':; ',\\[\\].<>/?~！@#￥……&*（）——|{}【】‘；：”“'。，、？]");
				t && n.test(t) ? i(new Error("输入信息包含特殊字符")) : i()
			}
		}
	}, function(e, t, i) {
		"use strict";
		...
		t.__esModule = !0, t.default = {
			...
			methods: {
				...
				setSelectdByValue: function(e) {
					...
					t || this.$message.error("值不存在")
				},
				setSelectdByItem: function(e) {
					e && !isNaN(e) ? this.typeOptions.length < e ? this.$message.error("设置的item超出下拉选项") : this.selectedVal =
						this.typeOptions[e].key : this.$message.error("值不存在或不是数字")
				},
				clear: function() {
					this.selectedVal = ""
				},
		...
		e.exports = {
			render: function() {
				...
				return i("div", {
					...
					attrs: {
						title: !e.node.isLeaf && e.expanded ? "展开" : "收缩"
					},
					on: {
						click: function(t) {
		...
		t.default = {
			...
			methods: {
				...
				handleTimeout: function(e, t) {
					this.onTimeout(e, i), this.$message("上传文件超时"), this.abort(i);
					var i = this.getFile(t);
					i.status = "fail"
				},
			...
			created: function() {
				for (var e = function(e) {
						...
						s +=
							...
							this.rowIndex && (this.indexlabelValue = this.indexlabel ? this.indexlabel : "序号", s +=
		...
		t.default = {
			...
			methods: {
				...
				privateRemoteData: function(e) {
					...
					var t = this;
					if (t.tabledata = [], t.selections = [], t.loading = !0, !t.dataUrl) throw new Error("ElTableX dataUrl参数未配置");
					t.queryParam = e ? e : t.queryParam, e = yufp.extend(!0, {}, t.queryParam);
					var i = yufp.extend(!0, {}, t.baseParams),
						n = i[t.conditionKey],
						a = e[t.conditionKey];
			...
			dateFormatter: function(e, t, n) {
				...
				var r = {
					...
					s = a.replace(/{(y|m|d|h|i|s|a)+}/g, function(e, t) {
						var i = r[t];
						return "a" === t ? ["一", "二", "三", "四", "五", "六", "日"][i - 1] : (e.length > 0 && i < 10 && (i = "0" + i),
							i || 0)
					});
				return s
			},
