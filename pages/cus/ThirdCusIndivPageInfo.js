...
define([
    ...
    exports.ready = function (hashCode, data, cite) {
        yufp.lookup.reg('STD_ZB_CERT_TYP,STD_ZX_SEX,STD_ZX_MARR_STATUS,STD_LOAN_USE,STD_ZB_ACT_STSREPAY_DAY_TYPE,STD_ZB_ASSURE_MEANS,APPLY_CHANNEL_TYPE,' +
            ...
            'STD_ZB_CRD_LMT_TYPE,STD_PRD_REPAY_MODE,STD_ZB_ACC_STATUS,REL_COUNTRY');
        yufp.custom.vue({
            el: cite.el,
            data: function () {
                var _self = this;
                return {
                    baseTab: 'baseTab',
                    dataUrl: backend.cusService + "/api/cus/indivs/third",
                    ...
                    tableColumns: [
                        ...
                        {label: 'ECIF第三方客户号', prop: 'innerCusId', sortable: true, resizable: true},
                    ...
                    identityInfoFields: [{
                        ...
                        fields: [
                            ...
                            {field: 'innerCusId', label: 'ECIF第三方客户号', disabled: true},
                ...
                exportFn: function () {
                    ...
                    _self.$confirm('是否导出数据?', '提示').then(function () {
                        yufp.util.exportExcelByTable({
                            ...
                            url: backend.cusService + '/api/cus/indivs/third',
                            method: 'POST',
                            param: {
                                cusId: formValue.cusId,
                                cusName: formValue.cusName,
