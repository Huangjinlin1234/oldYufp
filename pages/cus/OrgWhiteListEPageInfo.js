      ...
      yufp.custom.vue({
        ...
        data: function () {
          ...
          return {
            ...
            { placeholder: '客户近12个月收入放大倍数', field: 'biggerMul', type: 'input' },
            { placeholder: '机构所在地', field: 'area', type: 'input' },
            ...
            { label: '客户近12个月收入放大倍数', prop: 'biggerMul', sortable: true, resizable: true },
            { label: '机构所在地', prop: 'area', sortable: true, resizable: true },
            ...
            updateFields: [{
              ...
              fields: [
                	 ...
                	 { field: 'biggerMul', label: '客户近12个月收入放大倍数'},
                	 { field: 'area', label: '机构所在地'},
