                ...
                return {
                    editFields: [{
                        ...
                        fields: [
                            ...
                            { field: 'author',label: '作者',placeholder:' 编辑人姓名', digit:2, formatter:yufp.util.moneyFormatter},
                            { field: 'telNumber',label: '联系电话',type: 'input',placeholder:' 编辑人联系电话'},
                            { field:'time',label:'发布时间',type:'daterange',placeholder:'设置自动发布时间'},
                            { field: 'mount', label: '所需费用', type: 'num', digit:2, formatter:yufp.util.moneyFormatter, 
                                rules: [{required: true, message: '必填项', trigger: 'blur', type:'number'}]
                               },
                            { field: 'completePercent', label: '完成度', type: 'num', formatter: yufp.util.toPercent,
                                rules: [{required: true, message: '必填项', trigger: 'blur', type:'number'}]
                            },
