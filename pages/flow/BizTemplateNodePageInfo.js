      ...
      yufp.custom.vue({
        ...
        data: function () {
          ...
          return {
            ...
            queryFields: [
            { placeholder: '业务节点标识', field: 'bizNodeId', type: 'input' },
            { placeholder: '业务节点名称', field: 'bizNodeName', type: 'input' },
            { placeholder: '业务流转节点类型', field: 'bizNodeType', type: 'input' },
            { placeholder: '备注', field: 'remarks', type: 'input' }
            ],
            queryButtons: [
            ...
            { label: '业务流转节点类型', prop: 'bizNodeType', sortable: true, resizable: true },
            { label: '备注', prop: 'remarks', sortable: true, resizable: true }
            ],
            updateFields: [{
              columnCount: 3,
              fields: [
                	 { field: 'bizNodeId', label: '业务节点标识'},
                	 { field: 'bizNodeName', label: '业务节点名称'},
                	 { field: 'bizNodeType', label: '业务流转节点类型'},
