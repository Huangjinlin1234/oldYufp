...
define(function (require, exports) {
    ...
    exports.ready = function (hashCode, data, cite) {
        ...
        yufp.lookup.reg('APRV_OPINION_BASE');
        //创建virtual model
            ...
            data: function(){
                ...
                return {
                    editFields: [{
                        columnCount: 2,
                        fields: [
                            { field: 'aprvOpinion', label: '处理结果', value: aprvInfo.aprvOpinion || '',disabled:data.disabled != null?data.disabled:false,
                                dataCode: 'APRV_OPINION_BASE', type: 'radio',rules:[{ required: true, message: '请选择审批结果', trigger: 'blur' }]
                            }
                        ]
                    },{
                        columnCount: 1,
                        fields: [
                            { field: 'aprvComment', label: '处理意见', value: aprvInfo.aprvComment || '',disabled:data.disabled != null?data.disabled:false,
                                type: 'textarea', rows: 3 ,rules:[{ required: true, message: '请填写处理意见', trigger: 'blur' }]
                            }
                        ]
                    }],
                    buttons: [        
                        {label: '重置', op: 'reset', type: 'primary', icon: "yx-loop2" ,hidden:data.disabled != null?data.disabled:false, click: function (model) {
                                me.isEndDone = !me.isEndDone;
                        }},
                        {label: '保存', type: 'primary', icon: "check", op:'submit',hidden:data.disabled != null?data.disabled:false, click: function (model,valid) {
                            if(valid){
