      ...
      yufp.custom.vue({
        ...
        data: function () {
          ...
          return {
            ...
            updateButtons: [
            	...
            	{ label: '保存', type: 'primary', icon: 'check', hidden: false, click: function (model) {
            		...
            		if(_self.viewType == "EDIT") {
            			rMethod = 'PUT';
            			url = backend.flowService + '/api/biz/plugin/page';
            		} else if(_self.viewType == "ADD") {
            			rMethod = 'POST';
            			url = backend.flowService + '/api/biz/plugin/page/back';
            		}
            ...
            dataUrl: backend.flowService + '/api/biz/plugin/pages',
