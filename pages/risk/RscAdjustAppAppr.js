...
define(function (require, exports) {
    ...
    exports.ready = function (hashCode, data, cite) {
        // 引入字典项
        yufp.lookup.reg('STD_ZB_FIVE_SORT,STD_ZB_CERT_TYP,APPLY_CHANNEL_TYPE,STD_ZB_ACC_STATUS,STD_ZB_ASSURE_MEANS,S_ZB_GENE_WAY,APRV_STATUS,S_ZB_TASK_TYPE');
        yufp.custom.vue({
            el: cite.el,
            data: function () {
                var _self = this;
