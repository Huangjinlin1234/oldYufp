        ...
        yufp.custom.vue({
            ...
            data: function () {
                ...
                return {
                    ...
                    //  风险分类调整申请表
                    RscAdjustAppUrl: backend.flowService +'/api/rsc/adjust/remove/apps',
                    ...
                    rscAdjustAppTableColumns:[
                        ...
                        { label: '机评分类结果', prop: 'adjustBasic', sortable: true, resizable: true ,type: 'select',dataCode:'STD_ZB_FIVE_SORT'},
                        ...
                        { label: '申请人所属机构', prop: 'inputBrName', sortable: true, resizable: true ,hidden:true},
                    ...
                    updateFields: [{
                        columnCount: 3,
                        fields: [
                            { field: 'rscRmNo', label: '分类解除流水号',disabled: true,hidden:true},
                            { field: 'rscAdjNo', label: '分类调整流水号',disabled: true,rules: [{required: true, message: '分类调整流水号是必填项'}]},
                            ...
                            { field: 'mainBrName', label: '主管机构',hidden:true,disabled: true},
            ...
            methods: {
                ...
                switchParamsStatus: function () {
                    ...
                    if (_self.viewType != 'ADD') {
                        ...
                        _self.$refs.applyInfoRef.switch('inputBrName','hidden', false);
                        ...
                        _self.$refs.applyInfoRef.switch('rscRmNo','hidden', true);
                ...
                exportFn: function () {
                    ...
                    this.$confirm('是否导出数据?', '提示').then(function () {
                        yufp.util.exportExcelByTable({
                            ...
                            url: backend.flowService + '/api/rsc/adjust/remove/apps',
                            method:'POST',
                            param:{
                                rscRmNo:rscRmNo,
                                rscAdjNo:rscAdjNo,
