    ...
    exports.ready = function (hashCode, data, cite) {
      ...
      yufp.custom.vue({
        ...
        data: function () {
          var _self = this;
          return {
        	reftableDataUrl: backend.riskmService + '/api/laws/coopr/org/infos',
            baseParams: {
            	cooprOrgType: '002'
            },

            queryFields: [
                { placeholder: '律师事务所编号', field: 'cooprOrgNo', type: 'input' },
                { placeholder: '律师事务所名称', field: 'cooprOrgName', type: 'input' },
            ...
            tableColumns: [
                { label: '律师事务所编号', prop: 'cooprOrgNo', sortable: true, resizable: true },
                { label: '律师事务所名称', prop: 'cooprOrgName', sortable: true, resizable: true },
                ...
                { label: '最后更新时间', prop: 'lastUpdateTime', sortable: true, resizable: true, formatter: function (row, column, cellValue) {
            ...
            updateFields: [{
              columnCount: 2,
              fields: [
                	 { field: 'cooprOrgNo', label: '律师事务所编号',disabled:true, placeholder: '系统自动生成', rules: [{ required: true, message: '必输项', trigger: 'blur' }]},
                	 { field: 'cooprOrgName', label: '律师事务所名称', rules: [{required: true, message: '必填项', trigger: 'blur'}]},
              ]},{
                columnCount: 1,
                fields: [
                ...
                columnCount: 2,
                fields: [
                     { field: 'cooprStatus', label: '合作状态', type: 'select', dataCode:'COOPR_STS' , rules: [{required: true, message: '必填项', trigger: 'blur'}]},
                	 ...
                	 { field: 'commRate', label: '佣金率(%)', type: 'num', formatter: yufp.util.decimalToPercent,
                	 ...
                	 { field: 'copyEmail', label: '抄送邮箱', hidden:true, rules: [{ validator: yufp.validator.email, trigger: 'blur'}]},
                	 ...
                	 { field: 'cooprOrgType', label: '合作机构类型', type: 'select',dataCode:'COOPR_ORG_TYPE',value:'002', hidden:true},
            ...
            updateButtons: [
              { label: '保存', type: 'primary', icon: 'check', hidden: false, click: function (model) {
                  ...
                  if (_self.viewType == "EDIT") {
                      ...
                      rMethod = 'POST';
                      opUrl = backend.riskmService + '/api/law/org/info';
          ...
          */
          ...
          addFn: function () {
            ...
            _self.$nextTick(function () {
                ...
                _self.getLawFirmOrgNo();
            });
          },

          getLawFirmOrgNo: function() {
                var _self = this;
                yufp.service.request({
                    method: 'GET',
                    url: backend.riskmService + '/api/law/firm/risk/org/no',
                    data: {
                    },
                    callback: function (code, message, response) {
                        if (response.code == 0 ) {
