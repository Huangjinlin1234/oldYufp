        ...
        yufp.custom.vue({
            ...
            methods: {
                ...
                taskAllocationFn: function () {
                    ...
                    if('01' != obj.taskSts){
                        _self.$message('只能处理任务状态为"待处理"的数据');
                        return;
                    }
                ...
                artificialFlowFn: function () {
                    ...
                    if (taskSts != '01') {
                        this.$message({message: '只能处理任务状态为"待处理"的数据', type: 'warning'});
                        return;
                    }
