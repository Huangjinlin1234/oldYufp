...
define(function (require, exports) {
    ...
    exports.ready = function (hashCode, data, cite) {
        yufp.lookup.reg('CRUD_TYPE,STD_ZB_CONT_STATUS,STD_ZB_LMT_STATE,STD_ZX_CUR_TYPE,FREEZE_OP_TYPE,STD_ZB_CERT_TYP,STD_ZX_YES_NO,FREEZE_REASON_TYPE,STD_ZB_APPR_STATUS,STD_ZX_QUERY_CASE');
        var vm = yufp.custom.vue({
            ...
            data: function () {
                ...
                return {
                    ...
                    baseParams: {},
                    baseTab: 'baseTab',
                    lmtDataUrl: backend.creditService + '/api/lmt/prd/cont/terminate',
                    terminateUrl: backend.creditService + "/api/lmt/terminate/apps",
            ...
            methods: {
                ...
                commitFn: function () {
                    ...
                    yufp.service.request({
                        method: rMethod,
                        url: backend.creditService + '/api/lmt/terminate/app/submit',
                        data: obj,
                        callback: function (code, message, response) {
                ...
                saveFn: function () {
                    ...
                    yufp.service.request({
                        method: rMethod,
                        url: backend.creditService + '/api/lmt/terminate/app',
                        data: obj,
                        callback: function (code, message, response) {
                            var data = response.data;
                            if (code == 0 && data >= 0) {
