      ...
      yufp.custom.vue({
        ...
        data: function () {
          ...
          return {
            ...
            { placeholder: '队列任务状态', field: 'queueTaskState', type: 'input' },
            { placeholder: '消费方标识', field: 'consumerId', type: 'input' },
            { placeholder: '挂起次数', field: 'hangTimes', type: 'input' },
            { placeholder: '响应码', field: 'rspCode', type: 'input' },
            { placeholder: '响应信息', field: 'rspMsg', type: 'input' },
            ...
            { label: '队列任务状态', prop: 'queueTaskState', sortable: true, resizable: true },
            { label: '消费方标识', prop: 'consumerId', sortable: true, resizable: true },
            { label: '挂起次数', prop: 'hangTimes', sortable: true, resizable: true },
            { label: '响应码', prop: 'rspCode', sortable: true, resizable: true },
            { label: '响应信息', prop: 'rspMsg', sortable: true, resizable: true },
            ...
            updateFields: [{
              ...
              fields: [
                	 ...
                	 { field: 'queueTaskState', label: '队列任务状态'},
                	 { field: 'consumerId', label: '消费方标识'},
                	 { field: 'hangTimes', label: '挂起次数'},
                	 { field: 'rspCode', label: '响应码'},
                	 { field: 'rspMsg', label: '响应信息'},
