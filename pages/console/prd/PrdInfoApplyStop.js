    ...
    exports.ready = function (hashCode, data, cite) {
      ...
      yufp.custom.vue({
        ...
        data: function () {
          var _self = this;
          return {
        	dataUrl: backend.consoleService + '/api/prd/info/stopApplys',
            ...
            baseFields: [{
                ...
                fields: [
                    ...
                    { field: 'prdThlDri', label: '产品类型', type: 'select', dataCode: 'PRD_THL_DRI', disabled:true, 
	               	 ...
	               	 { field: 'prdCoefficient', label: '产品系数', type:'num', disabled:true, hidden:true},
	               	 { field: 'currencyOpt', label: '币种', type: 'select', dataCode: 'STD_ZX_CUR_TYPE', disabled:true,
	               		 rules: [
	                            { required: true, message: '必填项', trigger: 'blur' }
	                        ]},
                    { field: 'limitAmt', label: '产品限额(万元)', type:'num', digit:2, formatter: yufp.util.moneyFormatter,disabled:true,
                      rules: [
            	...
            	columnCount: 2,
                fields: [
                	{ field: 'reqDesc', label: '产品停用描述', type: 'textarea',
                		rules: [
            ...
            otherFields: [{
                ...
                { field: 'crdApprFlowName', label: '业务流程', hidden:true},
            	 { field: 'amtApprFlowId', label: '提额流程', hidden:true },
	           	 { field: 'crdMeaMedolName', label: '额度测算模型', type: 'custom',is:'div-rule-coll-selector',params:{ruleCollType: '04', status:'1'},
            		 clickFn: function (value, model, args) {
                     }
                     ,selectFn:function(value, model, args){
                 ...
                 { field: 'crdMeaMedolId', label: '额度测算模型', hidden:true},
               	 ...
               	 { field: 'reqType', label: '请求类型', value: "04", hidden:true},
...
//              yufp.extend(this.$refs.otherRef.formModel, dataObj);
          ...
          openPrdRule: function() {
             this.exportData.formDisabled = true;
