/**
 * @create by wanglh4 on 2019-03-06
 * @description 客户限额
 */
define(function (require, exports) {
    ...
    exports.ready = function (hashCode, data, cite) {
        yufp.lookup.reg('CRUD_TYPE,QUOTA_LIMIT_STATUS,QUOTA_LIMIT_CUS_TYPE,QUOTA_LIMIT_TYPE');
        yufp.custom.vue({
            el: cite.el,
            data: function () {
                var _self = this;
                return {
                    ...
                    tableColumns: [
                        ...
                        { label: '限额类型', prop: 'quotaType', sortable: true, resizable: true, hidden: true },
                        { label: '客户类型', prop: 'cusType', sortable: true, resizable: true, dataCode: 'QUOTA_LIMIT_CUS_TYPE' },
                    ...
                    updateFields: [{
                        ...
                        fields: [
                            ...
                            /*{ field: 'quotaType', label: '限额类型', disabled:true,type: 'select', dataCode: 'QUOTA_LIMIT_TYPE',
                            ...
                            { field: 'cusType', label: '客户类型', type: 'select', dataCode: 'QUOTA_LIMIT_CUS_TYPE' , disabled:true},
            ...
            methods: {
                ...
                switchParamStatus: function () {
                    if (this.viewType == 'ADD'){
                        ...
                        this.$refs.reform.switch('cusType','disabled',false);
                        ...
                        this.$refs.reform.switch('cusType','disabled',true);
                    ...
                    if (model != null) {
                        if (status == '00') {
                            if (model.sts == '01') {
                                ...
                                _self.$message({message: '只有有效状态的额度才能被置为无效!', type: 'warning'})
                            }
                        } else {
                            if (model.sts == '00') {
                                ...
                                _self.$message({message: '只有无效状态的限额才能被置为有效！', type: 'warning'})
                            }
                        }
                    } else {
