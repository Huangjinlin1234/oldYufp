...
define([
  ...
  exports.ready = function (hashCode, data, cite) {
    yufp.lookup.reg('STD_ZB_ASSURE_MEANS,STD_ZB_ACC_STATUS,STD_PRD_REPAY_MODE,TERM_STATUS,SETL_TYP,STD_ZB_CERT_TYP,APPLY_CHANNEL_TYPE,IMAGE_TYPE,STD_IS_OVER,TD_LEND_TYPE');
    yufp.custom.vue({
      el: cite.el,
      data: function () {
        var _self = this;
        return {
          ...
          dataUrl: backend.creditService + '/api/acc/hisLoans',
          dataUrlLRdetail: backend.creditService + '/api/loan/repay/detail',
          dataUrlLRplan: backend.creditService + '/api/loan/repay/hisPlan',
          
          dataUrlImages: backend.edocService +'/api/query/image/platfrom/hisFiles',
...
//            	_self.$refs.fromPrd.fm.prdName=''; //当下拉框值改变时，清空pop框产品值
         ...
         tableColumnsLRplan: [
             ...
             { label: '是否逾期过', prop: 'overdueFlag', sortable: true, resizable: true, dataCode: 'STD_IS_OVER'},
      ...
      methods: {
          ...
          /*postWindow: function(scope){
              ...
              imageForm.action = scope.imagePlatfromUrl;
              imageForm.target = "_blank";
              var hideInput1 = document.createElement("input");
              hideInput1.type = "hidden";
              hideInput1.name = "UID";
              hideInput1.value = scope.imagePlatfromUserName;
              var hideInput2 = document.createElement("input");
              hideInput2.type = "hidden";
              hideInput2.name = "PWD";
              hideInput2.value = scope.imagePlatfromPassWord;
              var hideInput3 = document.createElement("input");
              hideInput3.type = "hidden";
              hideInput3.name = "AppID";
              hideInput3.value = scope.imagePlatfromAppId;
              ...
              hideInput8.value = 'BUSI_SERIAL_NO:'+scope.applySeq+';OBJECT_NAME:'+scope.imagePlatfromModelCode+';QUERY_TIME:'+startDate+';FILELEVEL:1;RIGHT:0100000';
