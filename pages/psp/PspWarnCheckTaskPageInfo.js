    ...
    exports.ready = function (hashCode, data, cite) {
        ...
        data: function () {
          ...
          return {
            ...
            { placeholder: '检查名称', field: 'chkName', type: 'input',hidden:true },
//            { placeholder: '检查任务类型', field: 'chkType', type: 'select' ,dataCode:'S_ZB_CHK_TYPE',hidden:true},
            ...
            { label: '检查名称', prop: 'chkName', sortable: true, resizable: true ,hidden:true},
...
//                            Number(num * 100).toFixed(4) + '%';
            ...
            updateFields: [{
              ...
              fields: [
                	 ...
                	 { field: 'chkName', label: '检查名称',hidden:true },    	 
