 ...
 */
(function (vue, $, name) {
	  yufp.lookup.reg('CRUD_TYPE,NATIONALITY,PUBLISH_STATUS,USER_STATUS');
    vue.component(name, {
        template: '<div>\
            ...
            <el-dialog-x title="用户数据列表" :visible.sync="dialogVisible" width="1050px">\
        ...
        data: function () {
            ...
            return {
                ...
                selectedVal: '',
                dialogVisible: false,
                dataUrl: backend.consoleService +'/api/s/users/org',///api/s/users
               ...
               queryButtons: [
                ...
                tableColumns: [
                        ...
                        {label: '状态', prop: 'status', type:'select',dataCode:'USER_STATUS',sortable: true, resizable: true, dataCode: 'USER_STATUS'},
                        {label: '联系电话', prop: 'telPhone', sortable: true, resizable: true},
                        {label: '邮箱', prop: 'email', sortable: true, resizable: true},
                        {label: '性别', prop: 'sex', sortable: true, resizable: true},
                        {label: '最后登录时间', prop: 'lastLoginTime', sortable: true, resizable: true},
                        {label: '备注', prop: 'memo', sortable: true, resizable: true},
        ...
        methods: {
            ...
            confirmFn: function () {
                ...
                this.selectedVal = this.selections[0].userCode;
...
})(Vue, yufp.$, 'grant-auth-user-selector');
