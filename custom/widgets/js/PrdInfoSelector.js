    ...
    vue.component(name, {
        ...
        data: function () {
            ...
            return {
                ...
                tableColumns: [
                   { label: '产品ID', prop: 'prdId', resizable: true ,hidden:true },
                   { label: '产品编号', prop: 'prdCode', resizable: true },
                   { label: '产品名称', prop: 'prdName', sortable: true, resizable: true },
                   { label: '渠道', prop: 'prdType', sortable: true, resizable: true, dataCode:'APPLY_CHANNEL_TYPE' },
...
})(Vue, yufp.$, 'div-prd-info-selector');