/**
 * div-duty-selecter 岗位选择器 注：自定义组件规范： 1、对外默认提供v-model配置,raw-value
...
(function (vue, $, name) {
    vue.component(name, {
        template: '<div>\
            ...
            <el-dialog title="岗位列表" :visible.sync="dialogVisible" size="large" top="5%">\
              <el-row>\
               <el-col :span="12">\
            ...
            return {
              ...
              selections: [],
               queryFields: [
                ...
                selectedVal: '',
                dialogVisible: false,
                dataUrl: backend.consoleService + '/api/s/dutys/legal/status',
                tableColumns: [
          ...
          // this.myLoading = false;
            ...
            deleteFn: function () {
                ...
                for (var j = 0; j < data.length; j++) {
                   if ( data[j].dutyCode == selections[i].dutyCode)  {
                    data.splice(j,1);
                    break;
                   }
                }
          ...
          // this.myLoading = false;
            ...
            confirmFn: function () {
              ...
              var selections =_self.$refs.mytableTwo.data;
                ...
                for (var i = 0; i < len; i++) {
                   if ( i < len - 1){
                   selectId += selections[i].dutyCode + ',';
                   } else{
                    selectId += selections[i].dutyCode;
                   }  
                }
