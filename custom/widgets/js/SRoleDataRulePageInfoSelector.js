...
(function (vue, $, name) {
    vue.component(name, {
        template: '<div>\
            ...
            <el-dialog-x title="数据权限列表" :visible.sync="dialogVisible" size="large">\
        ...
        data: function () {
            ...
            return {
              ...
              selectedVal: '',
              dialogVisible: false,
              dataUrl: backend.consoleService +'/api/s/data/perss',
              queryFields: [
                  { placeholder: '菜单url', field: 'dataPersId', type: 'input'},
                  { placeholder: '菜单描述', field: 'dataPersDesc' ,type:'input'}],
               queryButtons: [
                ...
                tableColumns: [
                    { label: '菜单url', prop: 'dataPersId',width:300,sortable: true, resizable: true },
                    { label: '菜单描述', prop: 'dataPersDesc',width:250,sortable: true, resizable: true},
                    { label: '前端资源菜单', prop: 'frontEndPage',sortable: true, resizable: true}
        ...
        methods: {
            ...
            confirmFn: function () {
                ...
                this.selectedVal = this.selections[0].dataPersId;
                this.$emit('input', this.selections[0].dataPersId);
                //这个是你自定义返回的接口事件
...
})(Vue, yufp.$, 'srole-data-rule-selector');
