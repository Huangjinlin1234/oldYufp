...
(function (vue, $, name) {
    vue.component(name, {
        template: '<div>\
            ...
            <el-dialog-x title="业务事件节点选择器" :visible.sync="dialogVisible" >\
        ...
        data: function () {
            return {
                ...
                baseParams: {
                    ...
                    bizEventId: (this.params && this.params.bizEventId) || ''
                },
                dataUrl: backend.flowService + '/api/biz/flow/nodesByEventAndFlow',
                tableColumns: [
...
})(Vue, yufp.$, 'yufp-biz-event-node-selector');
