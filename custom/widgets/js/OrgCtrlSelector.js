    ...
    vue.component(name, {
        ...
        data: function () {
            ...
            return {
                ...
                queryFlag: true,
            	myLoading: true,
            	orgLevel: (this.params && this.params.orgLevel ) || '',
            	...
            	queryFields: [
                  ...
                  { placeholder: '机构层级', field: 'orgLevel', type: 'input', hidden: true }
                ],
                selectedVal: '',
                dialogVisible: false,
        ...
        watch: {
            ...
            params: function (val) {
                this.params = val;
                this.orgLevel = this.params.orgLevel;
                this.$refs.mytable.remoteData({orgLevel : this.orgLevel});
            }
        }

    });
})(Vue, yufp.$, 'div-org-ctrl-selector');
